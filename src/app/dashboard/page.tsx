...
export default function DashboardPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-100 text-slate-900 p-4 md:p-8 font-mono">
      <div className="max-w-5xl mx-auto space-y-6">
        
        <header className="border-b border-slate-200 pb-4 flex justify-between items-end gap-4">
          <div>
          ...
          <button 
            ...
            className="text-sm bg-white hover:bg-slate-100 text-slate-700 border border-slate-200 px-3 py-1 rounded transition-colors shadow-sm"
          >
            Logout
          </button>
        </header>
        ...
        <section className="bg-white border border-slate-200 rounded-2xl p-6 lg:p-10 flex flex-col md:flex-row items-center justify-between gap-8 shadow-sm">
          ...
          <div className="flex flex-col items-center">
            <h2 className="text-slate-600 font-bold mb-4">Tandon Bawah (Sumur)</h2>
          ...
          <div className="flex flex-col items-center">
            <h2 className="text-slate-600 font-bold mb-4">Tandon Atas (Distribusi)</h2>
            <div className="relative w-32 h-48 border-4 border-slate-300 rounded-b-xl bg-slate-50 overflow-hidden shadow-inner">
              <div 
                className="absolute bottom-0 w-full bg-blue-500/70 border-t-2 border-blue-300 transition-all duration-700 ease-in-out"
